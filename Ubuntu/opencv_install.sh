...
# Bishop Anderson
# 2017-09-30
# Chama o Script após configurar as variaveiss:
# version - A versão que será instalada do OpenCVd
# downloadfile - O nome do arquivo OpenCV que será baixado.
# dldir - Download do Diretorio (opcional, se não for especificado, cria um diretorio OpenCV no diretorio de trabalho)
if [[ -z "$version" ]]; then
