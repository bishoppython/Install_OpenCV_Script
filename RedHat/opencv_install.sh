# Bishop Anderson
# 2017-09-30
# Chama esse Script depois de configrar as Variaveis::
# version - a versão do OpenCV a ser instaladad
# downloadfile - o nome do arquivo OpenCV que será baixado
# dldir - Baixa o Diretorio (Sendo Opcional, se não for criar diretorios especificos no OpenCv ele ficará no diretorio de trabalho))
if [[ -z "$version" ]]; then
